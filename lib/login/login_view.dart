import 'package:gurukulam_app/login/login_view_model.dart';
    ...
    return Form(
      ...
      child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
        ...
        TextFormField(
          ...
          decoration: inputDecoration('Image Url', Icons.person),
        ),
        ElevatedButton(
          onPressed: () async {
            if (formKey.currentState?.validate() ?? false) {
              await _viewModel.registerUser(emailCtr.text, passwordCtr.text, imageUrlCtr.text);
              setState(() {
